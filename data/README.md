...
| **E-OBS** daily gridded climate (old/sensitivity precipitation + daily temperature) | `03_covariate_extraction.R` | `E_OBS_Climate/{rr,tg,tn,tx}_ens_mean_0.1deg_reg_v32.0e.nc` (precip, mean, min, max), 0.1° | ECA&D E-OBS ensemble gridded dataset, v32.0e: https://surfobs.climate.copernicus.eu/dataaccess/access_eobs.php#datafiles |
| **Esri Sentinel-2 10 m Land Cover** (figure background + upstream land-cover distance rasters) | `plot_studyarea.py` | `esri_lulc/{37S,37T,38S,38T}_20220101-20230101.tif` (2022 epoch, UTM 37/38 S/T) | Esri Sentinel-2 10 m Land Cover, via the Living Atlas Land Cover Explorer: https://livingatlas.arcgis.com/landcoverexplorer/ |
